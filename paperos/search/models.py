...
class FulltextLocation:
    ...
    Important:
    - URL candidates may come from public direct PDF links or provider API download endpoints.
    - `request_headers` exists for provider-owned download APIs such as CORE
      /v3/outputs/{id}/download, which requires Authorization.
